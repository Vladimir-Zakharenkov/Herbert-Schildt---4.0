...
//Использовать структуру PacketHeader для создания записи транзакции в сфере электронной коммерции.
class Transaction
{
    ...
    public void sendTrasaction()
    {
        Console.WriteLine("Пакет #: " + ph.PackNum + ", Длина: " + ph.PackLen +
